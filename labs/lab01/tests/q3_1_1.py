test = {   'name': 'q3_1_1',
    ...
    'suites': [   {   'cases': [   {   'code': ">>> # It looks like you didn't give anything the name;\n"
                                               ...
                                               '>>> # just need to run the cell below Question 3.1.1 where you;\n'
                                               '>>> # defined seconds_in_a_decade.;\n'
                                   ...
                                   {   'code': ">>> # It looks like you didn't account for leap years.;\n"
                                       ...
                                       'hidden': False,
                                       'locked': False},
                                   {   'code': '>>> # This is the correct answer, but instead of copying it;\n'
                                               '>>> # See if you can figure out how to calculate it;\n'
